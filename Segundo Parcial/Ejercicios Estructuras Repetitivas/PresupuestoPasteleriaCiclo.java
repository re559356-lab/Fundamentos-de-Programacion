...
public class PresupuestoPasteleriaCiclo {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("\n=== PASTELERIA: PRESUPUESTO DE TARTAS ===");
            ...
            switch (opcionSabor) {
                ...
                case 3:
                    ...
                    if (opcionChocolate == 1) {
                        ...
                        System.out.print("\n¿Deseas realizar otro presupuesto? (si/no): ");
            ...
            // Preguntar si desea realizar otro presupuesto
            System.out.print("\n¿Deseas hacer otro presupuesto de tarta? (si/no): ");
            respuesta = scanner.next().trim().toLowerCase();
            
        } while (respuesta.equals("si") || respuesta.equals("s") || respuesta.equals("sí"));
        
        System.out.println("\n¡Sistema de pastelería finalizado. ¡Hasta luego!");
        scanner.close();
    }
}